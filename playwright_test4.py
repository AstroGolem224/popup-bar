...
def run_cuj(page):
    # Register mock scripts before anything loads so Tauri bridge uses them immediately.
    page.add_init_script("""
        ...
        // This is necessary because some tauri APIs might check window.__TAURI__
        window.__TAURI__ = {};
    """)
