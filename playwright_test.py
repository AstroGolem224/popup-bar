...
def run_cuj(page):
    # As noted in memory:
    # "When attempting Playwright visual verification for the Vite frontend, inject a window.__TAURI_INTERNALS__ mock...
    #  pnpm preview can be used to locally serve the production-built application on http://localhost:4173"
